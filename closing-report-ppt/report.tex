...
\begin{document}
	...
	\begin{frame}{研究结论}
		...
		https://hkfnvg-cxtaem-3000.preview.myide.io
	...
	\begin{frame}{网站介绍}
		\includemedia[width=1\linewidth,height=0.8\linewidth,activate=pageopen,
		passcontext,
		transparent,
		addresource=show.mp4,
		flashvars={source=show.mp4}
		]{\includegraphics[width=1\linewidth]{show}}{VPlayer.swf}
	\end{frame}


	\begin{frame}{网站介绍}
		网站前端使用 Semantic-UI 实现，后端使用 Node.js 的 Express 框架实现，使用者输入数据后，会通过 https 请求发送给服务器进行处理，通过和本地的 C++ 程序交互，既能减轻用户的计算压力，又能保证高效。
