...
\node at (Aa.east) {$\qquad 2x^{\texttt{B}}$};
...
$$\begin{aligned}F(x) &= x^{\texttt{A}}(2\times(3x^{\texttt{B}}+x^{\texttt{b}})+2x^{\texttt{B}})+x^{\texttt{a}}(2x^{\texttt{B}}) \\ &= 2x^{\texttt{aB}}+2x^{\texttt{Ab}}+8x^{\texttt{AB}}\end{aligned}$$
