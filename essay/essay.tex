...
\tikzset{
	...
	bluenode/.style={treenode,circle,minimum width=30pt,minimum height=30pt,draw=blue},
	rednode/.style={treenode,circle,minimum width=30pt,minimum height=30pt,draw=red},
	blacknode/.style={treenode,circle,minimum width=30pt,minimum height=30pt,draw=black},
}
...
这是一棵插入了 $\texttt{AABb},\texttt{AABB},\texttt{AaBB}$ 的 Trie 树。
